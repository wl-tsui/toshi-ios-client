...
/**
  An array of strings identifying the types of metadata objects to process. Conforms to \code
  AVMetadataObjectType
  \endcode naming convention.
...
- (CAShapeLayer * _Nonnull)newMaskLayer;
...
/**
  ...
  \param instructions A string to explain to the user what they should do.
...
*/
- (nonnull instancetype)initWithInstructions:(NSString * _Nonnull)instructions scanner:(CameraScanner * _Nonnull)scanner startScanningAtLoad:(BOOL)startsScanning showSwitchCameraButton:(BOOL)showSwitch showTorchButton:(BOOL)showTorch OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
