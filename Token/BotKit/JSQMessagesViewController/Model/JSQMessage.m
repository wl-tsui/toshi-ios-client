                            ...
                            text:(NSString *)text
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:NO isActionable:NO];
    if (self) {
        _text = [text copy];
    }
    return self;
                    ...
                    isActionable:(BOOL)isActionable
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:NO isActionable:isActionable];
    if (self) {
        _text = [text copy];
    }
    return self;
                           ...
                           media:(id<JSQMessageMediaData>)media
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName date:date isMedia:YES isActionable:NO];
    if (self) {
        _media = media;
    }
    return self;
