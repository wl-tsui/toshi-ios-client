...
- (IBAction)approveButtonPressed:(UIButton *)sender;
...
- (IBAction)rejectButtonPressed:(UIButton *)sender {
    [self.delegate messagesCollectionViewCellDidTapRejectButton:self];
}

- (IBAction)approveButtonPressed:(UIButton *)sender {
    [self.delegate messagesCollectionViewCellDidTapApproveButton:self];
}
