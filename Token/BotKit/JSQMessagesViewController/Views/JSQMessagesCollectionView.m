...
- (void)messagesCollectionViewCellDidTapApproveButton:(JSQMessagesCollectionViewCell *)cell {
    NSIndexPath *indexPath = [self indexPathForCell:cell];
    if (indexPath == nil) {
        return;
    }
    ...
    [self.actionsDelegate messageView:self didTapApproveAtIndexPath:indexPath];
}

- (void)messagesCollectionViewCellDidTapRejectButton:(JSQMessagesCollectionViewCell *)cell {
    NSIndexPath *indexPath = [self indexPathForCell:cell];
    if (indexPath == nil) {
        return;
    }

    [self.actionsDelegate messageView:self didTapRejectAtIndexPath:indexPath];
}
