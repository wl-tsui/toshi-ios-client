...
@implementation MediaAssetLegacyImageSignals

+ (SSignal *)imageForAsset:(MediaAsset *)asset imageType:(MediaAssetImageType)imageType size:(CGSize)size allowNetworkAccess:(bool)__unused allowNetworkAccess
{
    if (imageType == MediaAssetImageTypeFastScreen)
    {
        return [[self imageForAsset:asset imageType:MediaAssetImageTypeAspectRatioThumbnail size:CGSizeZero] then:[self imageForAsset:asset imageType:MediaAssetImageTypeScreen size:size]];
    }
    
    switch (imageType)
    {
        case MediaAssetImageTypeThumbnail:
        {
        ...
        {
            if (imageType == MediaAssetImageTypeScreen && asset.isVideo)
            ...
            if (imageType == MediaAssetImageTypeFullSize)
                size = MediaAssetImageLegacySizeLimit;
...
+ (SSignal *)imageDataForAsset:(MediaAsset *)asset allowNetworkAccess:(bool)__unused allowNetworkAccess
{
    return [[[SSignal alloc] initWithGenerator:^id<SDisposable>(SSubscriber *subscriber)
    {
        ALAssetRepresentation *representation = asset.backingLegacyAsset.defaultRepresentation;
...
+ (SSignal *)imageMetadataWithAsset:(MediaAsset *)asset
{
...
+ (void)startCachingImagesForAssets:(NSArray *)__unused assets imageType:(MediaAssetImageType)__unused imageType size:(CGSize)__unused size
{

}

+ (void)stopCachingImagesForAssets:(NSArray *)__unused assets imageType:(MediaAssetImageType)__unused imageType size:(CGSize)__unused size
{
...
+ (SSignal *)saveUncompressedVideoForAsset:(MediaAsset *)asset toPath:(NSString *)path allowNetworkAccess:(bool)__unused allowNetworkAccess
{
    return [[SSignal alloc] initWithGenerator:^id<SDisposable>(SSubscriber *subscriber)
    {
...
+ (SSignal *)avAssetForVideoAsset:(MediaAsset *)asset allowNetworkAccess:(bool)__unused allowNetworkAccess
{
