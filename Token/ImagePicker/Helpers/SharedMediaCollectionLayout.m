...
@interface SharedMediaCollectionLayout ()
{
...
@implementation SharedMediaCollectionLayout
...
- (void)prepareLayout
{
    ...
    for (NSUInteger i = 0; i < numberOfSections; i++)
    {
        ...
        if (itemCount != 0)
        {
            ...
            SharedMediaSectionHeader *sectionHeader = [[SharedMediaSectionHeader alloc] init];
