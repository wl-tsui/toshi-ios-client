...
@interface PhotoEditorCurvesToolView () <UIGestureRecognizerDelegate>
{
...
@property (nonatomic, weak) CurvesTool *curvesTool;

@end

@implementation PhotoEditorCurvesToolView
...
- (instancetype)initWithEditorItem:(id<PhotoEditorItem>)__unused editorItem
{
    ...
    if (self != nil)
    {
        ...
        {
            CurvesTool *curvesTool = (CurvesTool *)editorItem;
...
- (UILabel *)_levelLabel
{
    ...
    label.font = [Font systemFontOfSize:13];
...
{
    if (![value isKindOfClass:[CurvesToolValue class]])
        return;
...
- (void)updateCurve
{
    ...
    CurvesToolValue *curvesToolValue = (CurvesToolValue *)_value;
    
    CurvesValue *curvesValue = nil;
    ...
    [self renderCurveWithPoints:points color:[PhotoEditorCurvesToolView colorForCurveType:curvesToolValue.activeType] lineWidth:2];
}
...
- (void)handlePan:(UIPanGestureRecognizer *)gestureRecognizer
{
    switch (gestureRecognizer.state)
    {
        ...
        {
            CurvesToolValue *newValue = [(CurvesToolValue *)_value copy];
            
            CGPoint translation = [gestureRecognizer translationInView:gestureRecognizer.view];
            CGFloat delta = MIN(2, -1 * translation.y / 8.0f);
            
            CurvesValue *curveValue = nil;
