...
@implementation PhotoEditorButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken, ^
        {
            ...
            CGContextSetFillColorWithColor(context, [PhotoEditorInterfaceAssets editorButtonSelectionBackgroundColor].CGColor);
        ...
        _button = [[ModernButton alloc] initWithFrame:self.bounds];
...
- (void)setIconImage:(UIImage *)image activeIconImage:(UIImage *)activeIconImage
{
    ...
    CGContextSetFillColorWithColor(context, [PhotoEditorInterfaceAssets toolbarSelectedIconColor].CGColor);
...
- (UIImage *)_activeIconImage
{
    if (_activeIconImage == nil)
    {
        ...
        CGContextSetBlendMode (context, kCGBlendModeSourceAtop);
        CGContextSetFillColorWithColor(context, [PhotoEditorInterfaceAssets toolbarAppliedIconColor].CGColor);
