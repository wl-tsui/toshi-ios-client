...
@interface MediaPickerCell () <ModernGalleryTransitionView>
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _imageView = [[ImageView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
...
- (void)setItem:(NSObject *)item signal:(SSignal *)signal
{
    ...
    if (self.selectionContext != nil)
    {
        ...
        __weak MediaPickerCell *weakSelf = self;
        ...
        {
            __strong MediaPickerCell *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
...
- (void)checkButtonPressed
{
    ...
    [self.selectionContext setItem:(id<MediaSelectableItem>)self.item selected:_checkButton.selected animated:false sender:_checkButton];
}
