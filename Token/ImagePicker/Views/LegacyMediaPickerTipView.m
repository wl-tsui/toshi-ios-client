...
@interface LegacyMediaPickerTipView ()
{
    UIView *_wrapperView;
...
@implementation LegacyMediaPickerTipView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        NSString *shareTipText = [[NSString alloc] initWithFormat:TGLocalized(@"ShareFileTip.Text"), [StringUtils stringForDeviceType]];
        ...
        _doneButton = [[ModernButton alloc] init];
