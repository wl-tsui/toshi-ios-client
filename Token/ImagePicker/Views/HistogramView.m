...
- (void)setHistogram:(PhotoHistogram *)histogram type:(PGCurvesType)type animated:(bool)animated
{
    void (^changeBlock)(void) = ^
    {
        ...
        [self shapeLayer].fillColor = [PhotoEditorCurvesToolView colorForCurveType:type].CGColor;
    };
...
- (UIBezierPath *)_bezierPathForHistogramBins:(PhotoHistogramBins *)histogramBins
{
