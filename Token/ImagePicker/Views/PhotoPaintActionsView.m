...
@interface PhotoPaintActionsView ()
{
    ModernButton *_undoButton;
    ModernButton *_redoButton;
    ModernButton *_clearButton;
}
@end

@implementation PhotoPaintActionsView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        _undoButton = [[ModernButton alloc] init];
        ...
        _redoButton = [[ModernButton alloc] init];
        ...
        _clearButton = [[ModernButton alloc] init];
