...
- (NSArray *)parameters
{
    if (!_parameters)
    {
        _parameter = [PhotoProcessPassParameter parameterWithName:@"grain" type:@"lowp float"];
        _parameters = @[ _parameter,
                         [PhotoProcessPassParameter constWithName:@"permTexUnit" type:@"lowp float" value:@"1.0 / 256.0"],
                         [PhotoProcessPassParameter constWithName:@"permTexUnitHalf" type:@"lowp float" value:@"0.5 / 256.0"],
                         [PhotoProcessPassParameter constWithName:@"grainsize" type:@"lowp float" value:@"2.3"] ];
    }
