...
#import "PhotoEnhanceLUTGenerator.h"
#import "PhotoEnhanceInterpolationFilter.h"
#import "PhotoEditorRawDataInput.h"

@interface PGPhotoEnhanceFilter : GPUImageOutput <GPUImageInput>
{
    GPUImageOutput <GPUImageInput> *_initialFilter;
    
    PhotoEnhanceColorConversionFilter *_rgbToHsvFilter;
    PhotoEnhanceLUTGenerator *_lutGenerator;
    PhotoEditorRawDataInput *_lutDataInput;
    PhotoEnhanceInterpolationFilter *_interpolationFilter;
...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        _rgbToHsvFilter = [[PhotoEnhanceColorConversionFilter alloc] initWithMode:PGPhotoEnhanceColorConversionRGBToHSVMode];
        _initialFilter = _rgbToHsvFilter;
        
        _lutGenerator = [[PhotoEnhanceLUTGenerator alloc] init];
        ...
        _lutDataInput = [[PhotoEditorRawDataInput alloc] initWithBytes:NULL size:lutSize pixelFormat:GPUPixelFormatRGBA type:GPUPixelTypeUByte];
        ...
        _interpolationFilter = [[PhotoEnhanceInterpolationFilter alloc] init];
