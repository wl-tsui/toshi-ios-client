...
const CGFloat PaintNeonBrushSolidFraction = 0.41f;
const CGFloat PaintNeonBrushBorderFraction = 0.036f;

@implementation PaintNeonBrush
...
- (CGImageRef)generateNeonStampForSize:(CGSize)size
{
    ...
    CGFloat border = floor(size.width / 2 * PaintNeonBrushBorderFraction);
    
    CGFloat blueRadius = floor(size.width / 2 * PaintNeonBrushSolidFraction - border);
...
- (CGImageRef)stampRef
{
    ...
    if (image == NULL)
    {
        image = [self generateNeonStampForSize:PaintBrushTextureSize];
    }
...
- (CGImageRef)previewStampRef
{
    ...
    {
        _previewStampRef = [self generateNeonStampForSize:PaintBrushPreviewTextureSize];
    }
