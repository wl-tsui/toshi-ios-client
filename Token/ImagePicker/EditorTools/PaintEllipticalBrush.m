...
const CGFloat PaintEllipticalBrushHardness = 0.89f;
const CGFloat PaintEllipticalBrushAngle = 125.0f;
const CGFloat PaintEllipticalBrushRoundness = 0.35f;

@implementation PaintEllipticalBrush
...
- (CGFloat)angle
{
    return TGDegreesToRadians(PaintEllipticalBrushAngle);
}
...
- (CGImageRef)stampRef
{
    ...
    if (image == NULL)
        image = [self generateEllipticalStampForSize:PaintBrushTextureSize hardness:PaintEllipticalBrushHardness roundness:PaintEllipticalBrushRoundness];
...
- (CGImageRef)previewStampRef
{
    ...
    {
        _previewStampRef = [self generateEllipticalStampForSize:PaintBrushPreviewTextureSize hardness:PaintEllipticalBrushHardness roundness:PaintEllipticalBrushRoundness];
    }
