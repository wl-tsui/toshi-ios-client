...
@interface PhotoEnhanceLUTGenerator ()
{
    CGFloat _clipLimit;
...
@implementation PhotoEnhanceLUTGenerator
...
- (void)newFrameReadyAtTime:(CMTime)__unused frameTime atIndex:(NSInteger)__unused textureIndex
{
    ...
    CGSize tileSize = CGSizeMake(floor(_imageSize.width / PGPhotoEnhanceSegments), floor(_imageSize.height / PGPhotoEnhanceSegments));
