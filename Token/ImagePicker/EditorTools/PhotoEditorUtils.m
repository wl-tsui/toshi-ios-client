...
const CGSize PhotoEditorResultImageMaxSize = { 1280, 1280 };
const CGSize PhotoEditorScreenImageHardLimitSize = { 750, 750 };

CGSize PhotoEditorScreenImageMaxSize()
{
    CGSize screenSize = TGScreenSize();
    CGFloat maxSide = MIN(PhotoEditorScreenImageHardLimitSize.width, TGScreenScaling() * MIN(screenSize.width, screenSize.height));
...
CGImageRef PhotoLanczosResize(UIImage *image, CGSize targetSize)
{
...
UIImage *PhotoEditorLegacyCrop(UIImage *image, UIImage *paintingImage, UIImageOrientation orientation, CGFloat rotation, CGRect rect, bool mirrored, CGSize maxSize, bool shouldResize)
{
    ...
    outputImageSize.width = floor(outputImageSize.width);
    outputImageSize.height = floor(outputImageSize.height);
...
UIImage *PhotoEditorCrop(UIImage *inputImage, UIImage *paintingImage, UIImageOrientation orientation, CGFloat rotation, CGRect rect, bool mirrored, CGSize maxSize, CGSize originalSize, bool shouldResize)
{
    return PhotoEditorVideoCrop(inputImage, paintingImage, orientation, rotation, rect, mirrored, maxSize, originalSize, shouldResize, false);
}
...
UIImage *PhotoEditorVideoCrop(UIImage *inputImage, UIImage *paintingImage, UIImageOrientation orientation, CGFloat rotation, CGRect rect, bool mirrored, CGSize maxSize, CGSize originalSize, bool shouldResize, bool useImageSize)
{
    ...
    if (shouldResize)
    {
        ...
        CGImageRef resizedImage = PhotoLanczosResize(inputImage, resizedSize);
...
UIImageOrientation VideoFinalOrientationForOrientation(UIImageOrientation videoOrientation, UIImageOrientation cropOrientation)
{
