...
extension SettingsController: UITableViewDataSource {
    ...
    private func cellForProfileSectionAt(indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let avatarPath = currentUserProfile.avatar else { return UITableViewCell() }
    ...
    private func cellForAdvancedSectionAt(indexPath: IndexPath) -> UITableViewCell {
        ...
        switch item {
        case .wallet:
            walletCellConfigurator.configureCell(cell, withTitle: Localized.settings_cell_wallet, value: selectedWallet?.name ?? "")
        case .network:
