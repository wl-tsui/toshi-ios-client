...
@interface PhotoProcessPassParameter ()
{
    NSString *_type;
    NSString *_value;
    BOOL _isConst;
...
@implementation PhotoProcessPassParameter
...
{
    PhotoProcessPassParameter *parameter = [[[self class] alloc] initWithName:name type:type count:0];
...
@implementation PhotoProcessPass
