...
+ (NSDictionary *)setup
{
    ...
    for (NSString *key in shaderSet.keyEnumerator)
    {
        ...
        PaintShader *shader = [[PaintShader alloc] initWithVertexShader:vertex fragmentShader:fragment attributes:attributes uniforms:uniforms];
        shaders[key] = shader;
    }
