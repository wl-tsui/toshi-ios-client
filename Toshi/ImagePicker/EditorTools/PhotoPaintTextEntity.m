...
@implementation PhotoPaintTextEntity
...
{
    PhotoPaintTextEntity *entity = [[PhotoPaintTextEntity alloc] initWithText:self.text font:self.font swatch:self.swatch baseFontSize:self.baseFontSize maxWidth:self.maxWidth stroke:self.stroke];
...
- (BOOL)isEqual:(id)object
{
    ...
    PhotoPaintTextEntity *entity = (PhotoPaintTextEntity *)object;
