...
#import "PhotoGaussianBlurFilter.h"
...
{
    PhotoGaussianBlurFilter *_blurFilter;
...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        _blurFilter = [[PhotoGaussianBlurFilter alloc] init];
...
- (void)setType:(BlurToolType)type
{
