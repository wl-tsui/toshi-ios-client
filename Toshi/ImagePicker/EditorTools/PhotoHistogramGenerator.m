#import "PhotoHistogramGenerator.h"
#import "PhotoHistogram.h"

@implementation PhotoHistogramGenerator
...
- (instancetype)init
{
    ...
    if (self != nil)
    {
        __weak PhotoHistogramGenerator *weakSelf = self;
        
        self.newFrameAvailableBlock = ^
        {
            __strong PhotoHistogramGenerator *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
            ...
            if (strongSelf.histogramReady != nil)
                strongSelf.histogramReady([[PhotoHistogram alloc] initWithLuminanceCArray:lumHist redCArray:redHist greenCArray:greenHist blueCArray:blueHist]);
        };
    }
    return self;
}
