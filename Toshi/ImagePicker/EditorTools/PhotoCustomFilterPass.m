...
NSString *const PhotoFilterDefinitionsShaderString = PGShaderString
(
...
NSString *const PhotoFilterMainShaderString = PGShaderString
(
 void main() {
...
@implementation PhotoCustomFilterPass
...
- (instancetype)initWithShaderString:(NSString *)shaderString textureImages:(NSArray *)textureImages
{
    ...
    if (self != nil)
    {
        NSMutableString *fullShaderString = [[NSMutableString alloc] initWithString:PhotoFilterDefinitionsShaderString];
        [fullShaderString appendString:shaderString];
        [fullShaderString appendString:PhotoFilterMainShaderString];
