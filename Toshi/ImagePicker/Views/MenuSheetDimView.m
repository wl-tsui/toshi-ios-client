...
@interface MenuSheetCutoutView : UIImageView

@end

@implementation MenuSheetCutoutView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        {
            CGRect rect = CGRectMake(0, 0, MenuSheetCornerRadius * 2, MenuSheetCornerRadius * 2);
            
            UIGraphicsBeginImageContextWithOptions(rect.size, false, 0);
            CGContextRef context = UIGraphicsGetCurrentContext();
            
            CGContextSetFillColorWithColor(context, [MenuSheetDimView backgroundColor].CGColor);
            ...
            image = [UIGraphicsGetImageFromCurrentImageContext() resizableImageWithCapInsets:UIEdgeInsetsMake(MenuSheetCornerRadius, MenuSheetCornerRadius, MenuSheetCornerRadius, MenuSheetCornerRadius)];
...
@property (nonatomic, weak) MenuSheetView *menuView;

@end

@implementation MenuSheetDimView
...
- (instancetype)initWithActionMenuView:(MenuSheetView *)menuView
{
    ...
    if (self != nil)
    {
        ...
        void (^setupView)(UIView *) = ^(UIView *view)
        {
            ...
            view.backgroundColor = [MenuSheetDimView backgroundColor];
        };
        ...
        if (MenuSheetUseEffectView)
        {
            ...
            _firstCutoutView = [[MenuSheetCutoutView alloc] initWithFrame:CGRectZero];
            _secondCutoutView = [[MenuSheetCutoutView alloc] initWithFrame:CGRectZero];
            _thirdCutoutView = [[MenuSheetCutoutView alloc] initWithFrame:CGRectZero];
        }
        else
        {
            _topView = [[UIView alloc] initWithFrame:CGRectZero];
...
- (void)setTheaterMode:(bool)theaterMode animated:(bool)animated
{
    ...
    {
        _topView.backgroundColor = theaterMode ? [MenuSheetDimView theaterBackgroundColor] : [MenuSheetDimView backgroundColor];
    };
...
- (void)layoutSubviews
{
    ...
    MenuSheetView *menuView = self.menuView;
    if (menuView == nil)
        return;
