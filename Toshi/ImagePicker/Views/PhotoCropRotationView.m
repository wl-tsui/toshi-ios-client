...
const CGFloat PhotoCropRotationViewMaximumAngle = 45;

@interface PhotoCropRotationView () <UIGestureRecognizerDelegate>
{
...
@implementation PhotoCropRotationView
...
- (void)setAngle:(CGFloat)angle animated:(bool)animated
{
    ...
    if (animated)
    {
        ...
        POPAnimatableProperty *angleProperty = [POPAnimatableProperty propertyWithName:@"org.telegram.rotationAngle" initializer:^(POPMutableAnimatableProperty *prop)
        {
            ...
            prop.writeBlock = ^(id obj, const CGFloat values[])
            {
                PhotoCropRotationView *view = (PhotoCropRotationView *)obj;
