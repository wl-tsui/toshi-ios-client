...
@interface MediaAssetsMomentsCollectionLayout ()
{
...
@implementation MediaAssetsMomentsCollectionLayout
...
- (void)prepareLayout
{
    ...
    for (NSUInteger i = 0; i < numberOfSections; i++)
    {
        ...
        if (itemCount != 0)
        {
            ...
            MediaAssetsMomentsSectionHeader *sectionHeader = [[MediaAssetsMomentsSectionHeader alloc] init];
