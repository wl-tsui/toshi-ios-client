...
@implementation MenuSheetItemView
...
- (void)menuView:(MenuSheetView *)__unused menuView willAppearAnimated:(bool)__unused animated
{
}

- (void)menuView:(MenuSheetView *)__unused menuView didAppearAnimated:(bool)__unused animated
{
}

- (void)menuView:(MenuSheetView *)__unused menuView willDisappearAnimated:(bool)__unused animated
{
}

- (void)menuView:(MenuSheetView *)__unused menuView didDisappearAnimated:(bool)__unused animated
{
}
