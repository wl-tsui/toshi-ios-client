...
- (void)updateForCameraModeChangeWithPreviousMode:(PGCameraMode)__unused previousMode
{
    switch (_modeControl.cameraMode)
    {
        ...
        {
            [_shutterButton setButtonMode:CameraShutterButtonNormalMode animated:true];
        ...
        {
            [_shutterButton setButtonMode:CameraShutterButtonVideoMode animated:true];
...
{
    [_shutterButton setButtonMode:recordingVideo ? CameraShutterButtonRecordingMode : CameraShutterButtonVideoMode animated:animated];
    if (recordingVideo)
    {
