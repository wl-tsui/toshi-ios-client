...
NSString *const AttachmentPhotoCellIdentifier = @"AttachmentPhotoCell";

@interface AttachmentPhotoCell () <ModernGalleryTransitionView>

@end

@implementation AttachmentPhotoCell
