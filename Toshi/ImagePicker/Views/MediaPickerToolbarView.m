...
const CGFloat MediaPickerToolbarHeight = 44.0f;

@interface MediaPickerToolbarView ()
{
    ModernButton *_leftButton;
    ModernButton *_rightButton;
    UIImageView *_countBadge;
    UILabel *_countLabel;
}
@end

@implementation MediaPickerToolbarView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _leftButton = [[ModernButton alloc] initWithFrame:CGRectMake(0, 0, 60, 44)];
        _leftButton.exclusiveTouch = true;
        [_leftButton setTitle:TGLocalized(@"Cancel") forState:UIControlStateNormal];
        ...
        _rightButton = [[ModernButton alloc] initWithFrame:CGRectMake(0, 0, 40, 44)];
        _rightButton.exclusiveTouch = true;
        [_rightButton setTitle:TGLocalized(@"Send") forState:UIControlStateNormal];
...
- (void)_setTitle:(NSString *)title forButton:(ModernButton *)button
{
