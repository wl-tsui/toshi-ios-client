...
const CGFloat PhotoEditorSliderViewLineSize = 3.0f;
const CGFloat PhotoEditorSliderViewMargin = 15.0f;
const CGFloat PhotoEditorSliderViewInternalMargin = 14.0f / 2.0f;

@interface PhotoEditorSliderView ()
{
...
@implementation PhotoEditorSliderView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _lineSize = PhotoEditorSliderViewLineSize;
        _knobPadding = PhotoEditorSliderViewInternalMargin;
        
        _backColor = [PhotoEditorInterfaceAssets sliderBackColor];
        _trackColor = [PhotoEditorInterfaceAssets sliderTrackColor];
        _startColor = [PhotoEditorInterfaceAssets sliderTrackColor];
...
- (void)drawRect:(CGRect)__unused rect
{
    ...
    CGFloat margin = PhotoEditorSliderViewInternalMargin;
