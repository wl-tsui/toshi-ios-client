...
@interface PhotoEditorGenericToolView ()
{
...
@implementation PhotoEditorGenericToolView
...
- (instancetype)initWithEditorItem:(id<PhotoEditorItem>)editorItem
{
    ...
    if (self != nil)
    {
        ...
        __weak PhotoEditorGenericToolView *weakSelf = self;
        ...
        {
            __strong PhotoEditorGenericToolView *strongSelf = weakSelf;
            if (strongSelf != nil)
