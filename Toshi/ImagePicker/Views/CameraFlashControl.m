...
const CGFloat CameraFlashControlHeight = 44.0f;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _autoButton.titleLabel.font = [CameraInterfaceAssets normalFontOfSize:13];
        [_autoButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashAuto") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets normalColor], NSKernAttributeName: @2 }] forState:UIControlStateNormal];
        [_autoButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashAuto") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets accentColor], NSKernAttributeName: @2 }] forState:UIControlStateSelected];
        ...
        _autoButton.frame = (CGRect){ CGPointZero, [CameraFlashControl _sizeForModeButtonWithTitle:[_autoButton attributedTitleForState:UIControlStateNormal]] };
        ...
        _onButton.titleLabel.font = [CameraInterfaceAssets normalFontOfSize:13];
        [_onButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashOn") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets normalColor], NSKernAttributeName: @2 }] forState:UIControlStateNormal];
        [_onButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashOn") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets accentColor], NSKernAttributeName: @2 }] forState:UIControlStateSelected];
        ...
        [_onButton sizeToFit];
        _onButton.frame = (CGRect){ CGPointZero, [CameraFlashControl _sizeForModeButtonWithTitle:[_onButton attributedTitleForState:UIControlStateNormal]] };
        ...
        _offButton.titleLabel.font = [CameraInterfaceAssets normalFontOfSize:13];
        [_offButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashOff") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets normalColor], NSKernAttributeName: @2 }] forState:UIControlStateNormal];
        [_offButton setAttributedTitle:[[NSAttributedString alloc] initWithString:TGLocalized(@"FlashOff") attributes:@{ NSForegroundColorAttributeName: [CameraInterfaceAssets accentColor], NSKernAttributeName: @2 }] forState:UIControlStateSelected];
        ...
        _offButton.frame = (CGRect){ CGPointZero, [CameraFlashControl _sizeForModeButtonWithTitle:[_offButton attributedTitleForState:UIControlStateNormal]] };
