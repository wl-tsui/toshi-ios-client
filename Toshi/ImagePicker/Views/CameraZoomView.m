...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _leftLine.backgroundColor = [CameraInterfaceAssets normalColor];
        [_wrapperView addSubview:_leftLine];
        
        _rightLine = [[UIView alloc] initWithFrame:CGRectMake(12.5f, (12.5 - 1.5f) / 2, 1000, 1.5f)];
        _rightLine.backgroundColor = [CameraInterfaceAssets normalColor];
        ...
        dispatch_once(&onceToken, ^
        {
            ...
            CGContextSetStrokeColorWithColor(context, [CameraInterfaceAssets accentColor].CGColor);
        ...
        _minusIconView.backgroundColor = [CameraInterfaceAssets normalColor];
        ...
        _plusIconView.backgroundColor = [CameraInterfaceAssets normalColor];
        _plusIconView.layer.cornerRadius = 1;
        [self addSubview:_plusIconView];
        
        CALayer *plusVertLayer = [[CALayer alloc] init];
        plusVertLayer.backgroundColor = [CameraInterfaceAssets normalColor].CGColor;
