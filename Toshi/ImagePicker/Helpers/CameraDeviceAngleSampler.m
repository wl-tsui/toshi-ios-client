...
@interface CameraDeviceAngleSampler ()
{
...
@implementation CameraDeviceAngleSampler
...
{    
    ...
    __weak CameraDeviceAngleSampler *weakSelf = self;
    ...
    {
        __strong CameraDeviceAngleSampler *strongSelf = weakSelf;
