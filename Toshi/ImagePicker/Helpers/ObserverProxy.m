...
@interface ObserverProxyScheduledNotification : NSObject
...
@implementation ObserverProxyScheduledNotification
...
@property (nonatomic) ObserverProxyScheduledNotification *pendingNotification;

@end

@implementation ObserverProxy
...
#pragma clang diagnostic pop
        ...
        {
            _pendingNotification = [[ObserverProxyScheduledNotification alloc] initWithTarget:self.target targetSelector:_targetSelector notification:notification passCount:_numberOfRunLoopPassesToDelayTargetNotifications];
