...
+ (NSString *)callingCodeFromCountryCode:(NSString *)countryCode
{
    ...
    NSString *callingCode = [NSString stringWithFormat:@"%@%@",
                             COUNTRY_CODE_PREFIX,
                             [[[TextSecureKitEnv sharedEnv].phoneNumberUtil nbPhoneNumberUtil] getCountryCodeForRegion:countryCode]];
    return callingCode;
}
...
+ (NSString *)examplePhoneNumberForCountryCode:(NSString *)countryCode
{
    ...
    [[[TextSecureKitEnv sharedEnv].phoneNumberUtil nbPhoneNumberUtil] getExampleNumberForType:countryCode
    ...
    NSString *result = (nbPhoneNumber ? [[[TextSecureKitEnv sharedEnv].phoneNumberUtil nbPhoneNumberUtil] format:nbPhoneNumber
