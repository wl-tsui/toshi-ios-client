...
SWIFT_MODULE_NAMESPACE_PUSH("EtherealCereal")
...
@property (nonatomic, copy) NSData * _Nonnull publicKeyData;
@property (nonatomic, copy) NSString * _Nonnull address;
@property (nonatomic, copy) NSData * _Nonnull privateKeyData;
- (NSString * _Nonnull)generateAddressFrom:(NSData * _Nonnull)publicKeyData SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nonnull)generatePublicKeyFrom:(NSData * _Nonnull)privateKeyData SWIFT_WARN_UNUSED_RESULT;
...
- (NSData * _Nonnull)generatePrivateKeyData SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)sha3WithString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
/// Returns a KECCAK-256 encoded in base64.
...
/// returns:
/// A KECCAK-256-encoded base64 encoded string.
- (NSString * _Nonnull)sha3WithData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)signWithMessage:(NSString * _Nonnull)message SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)signWithHex:(NSString * _Nonnull)hex SWIFT_WARN_UNUSED_RESULT;
