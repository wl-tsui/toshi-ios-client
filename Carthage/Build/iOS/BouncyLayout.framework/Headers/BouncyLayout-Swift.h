...
SWIFT_CLASS("_TtC12BouncyLayout12BouncyLayout")
@interface BouncyLayout : UICollectionViewFlowLayout
- (nonnull instancetype)initWithDamping:(CGFloat)damping frequency:(CGFloat)frequency;
- (void)prepareLayout;
...
@interface UIDynamicAnimator (SWIFT_EXTENSION(BouncyLayout))
- (void)addBehavior:(UIAttachmentBehavior * _Nonnull)behavior :(CGFloat)damping :(CGFloat)frequency;
@end
